...
public class ChitietquanActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        QuanAn quanAn = MainActivity.quanAn;
        ...
        if(userName ==null){
            ...
            if(sqlLiteDatabase.checkAddress(quanAn.getQuanAnId())) {
                sqlLiteDatabase.updateAddress(new QuanAn(quanAn.getQuanAnId(), quanAn.getTenQuanAn(), quanAn.getAddress(), quanAn.getPhone(), quanAn.getEmail(), quanAn.getAnh(), quanAn.getGiomocua()));
            }else{
                sqlLiteDatabase.addAddress(new QuanAn(quanAn.getQuanAnId(), quanAn.getTenQuanAn(), quanAn.getAddress(), quanAn.getPhone(), quanAn.getEmail(), quanAn.getAnh(), quanAn.getGiomocua()));

            }
                List<QuanAn> currentAddresses = sqlLiteDatabase.getCurrentAddress();
            System.out.println("Size"+currentAddresses.size()+ " hihi= "+currentAddresses.get(0).getQuanAnId());
